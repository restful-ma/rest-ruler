...
// gpt is a class that brings together the AI-related functionality in the CLI
// different rules may use the methods in this class to establish a connection to an AI agent for rule evaluation
public class gpt {
