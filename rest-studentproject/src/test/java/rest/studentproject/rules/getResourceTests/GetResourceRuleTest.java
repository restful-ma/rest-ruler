package rest.studentproject.rules.getResourceTests;

import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;
import rest.studentproject.analyzer.RestAnalyzer;
import rest.studentproject.rules.GetResourceRule;
import rest.studentproject.rules.Violation;
import rest.studentproject.rules.constants.ErrorMessage;
...
class GetResourceRuleTest {
    ...
    void checkResponseContent() {
        ...
        long num_missing_content = violationList.stream().filter( v-> v.getErrorMessage().equals(ErrorMessage.GET_RESOURCE)).count();
        long num_missing_response = violationList.stream().filter( v-> v.getErrorMessage().equals(ErrorMessage.GET_RESOURCE_MISSING_RESPONSE)).count();
