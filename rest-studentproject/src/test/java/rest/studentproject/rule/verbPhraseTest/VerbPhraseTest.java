package rest.studentproject.rule.verbPhraseTest;

import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;
import rest.studentproject.analyzer.RestAnalyzer;
import rest.studentproject.rule.Violation;
import rest.studentproject.rule.rules.PluralNameRule;
...
public class VerbPhraseTest {
    ...
    void checkViolationOnInvalidRESTFile2Violations() throws MalformedURLException {
        ...
        String url = "src/test/java/rest/studentproject/rule/verbPhraseTest/verbPhrase2Violations.json";
